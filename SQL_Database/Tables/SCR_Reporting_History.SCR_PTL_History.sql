...
[PATIENT_ID] [int] NULL CONSTRAINT [DF__SCR_PTL_H__PATIE__5FB337D6] DEFAULT ((0)),
...
[CWT_ID] [varchar] (255) NOT NULL CONSTRAINT [DF__SCR_PTL_H__CWT_I__60A75C0F] DEFAULT (''),
[Tx_ID] [varchar] (255) NOT NULL CONSTRAINT [DF__SCR_PTL_H__Tx_ID__619B8048] DEFAULT (''),
...
[HasTxMod] [int] NULL CONSTRAINT [DF__SCR_PTL_H__HasTx__628FA481] DEFAULT ((0)),
[HasChemRtLink] [int] NULL CONSTRAINT [DF__SCR_PTL_H__HasCh__6383C8BA] DEFAULT ((0)),
