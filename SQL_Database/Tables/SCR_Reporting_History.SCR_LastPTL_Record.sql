...
(
[InLastRefresh] [bit] NOT NULL CONSTRAINT [DF__SCR_LastP__InLas__0F624AF8] DEFAULT ((1)),
[PtlSnapshotId] [int] NOT NULL,
[CWT_ID] [varchar] (255) NOT NULL CONSTRAINT [DF__SCR_LastP__CWT_I__10566F31] DEFAULT (''),
[CARE_ID] [int] NOT NULL,
[PatientPathwayID] [varchar] (20) NULL,
[PatientPathwayIdIssuer] [varchar] (3) NULL,
[PATIENT_ID] [int] NULL CONSTRAINT [DF__SCR_LastP__PATIE__114A936A] DEFAULT ((0)),
...
[Tx_ID] [varchar] (255) NOT NULL CONSTRAINT [DF__SCR_LastP__Tx_ID__123EB7A3] DEFAULT (''),
...
[HasTxMod] [int] NULL CONSTRAINT [DF__SCR_LastP__HasTx__1332DBDC] DEFAULT ((0)),
[HasChemRtLink] [int] NULL CONSTRAINT [DF__SCR_LastP__HasCh__14270015] DEFAULT ((0)),
