...
Description:				Return the ODS code for the organisation this version of Somerset belongs to
**************************************************************************************************************************************************/

-- Test me
-- SELECT LocalConfig.fnOdsCode()

CREATE FUNCTION [LocalConfig].[fnOdsCode]()
